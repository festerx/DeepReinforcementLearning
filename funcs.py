...
def playMatches(player1, player2, EPISODES, logger, turns_until_tau0, memory=None, goes_first=0):
	...
	for e in range(EPISODES):
		...
		#player1.predictTime = 0.0
		#player2.predictTime = 0.0
		...
		ep_t2 = time.perf_counter()
		total_ep = ep_t2 - ep_t1
		total += total_ep
		#total_predict = player1.predictTime + player2.predictTime
		#player1.predictTime = 0.0
		#player2.predictTime = 0.0
		lg.logger_time_track.info('EPISODE %d OF %d took %f', e + 1, EPISODES, total_ep)
		#lg.logger_time_track.info('EPISODE %d OF %d took %f to provide model estimates', e + 1, EPISODES, total_predict)

	total = total / EPISODES

	lg.logger_time_track.info('It took on average %f to play %d episodes', total, EPISODES)
